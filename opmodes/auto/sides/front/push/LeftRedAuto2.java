...
//                AutoPathHelper.addRollerBackwardMovement(chassis, purpleActions);
                points.add(new AutoPoint(new Point(4.25 * Game.TS, 5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 4.75 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 4.5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 2 * Game.TS), purpleActions, false));
...
//                purpleActions.add(new TurnAction(chassis, 1, -45));
//                AutoPathHelper.addRollerBackwardMovement(chassis, purpleActions);
                points.add(new AutoPoint(new Point(4.25 * Game.TS, 4 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(5 * Game.TS, 4.25 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 4.5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 2 * Game.TS), purpleActions, false));
            ...
            default:
//                AutoPathHelper.addRollerBackwardMovement(chassis, purpleActions);
                points.add(new AutoPoint(new Point(4 * Game.TS, 4.5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 4.5 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 2 * Game.TS), purpleActions, false));
