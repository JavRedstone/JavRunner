...
public class RightBlueAuto extends BaseAuto {
    ...
    public void createPoints() {
        ...
        points.add(new AutoPoint(new Point(0, 4.5 * Game.TS), new ArrayList<>(), true));
...
//                AutoPathHelper.addRollerBackwardMovement(chassis, purpleActions);
                points.add(new AutoPoint(new Point(2 * Game.TS, 4.5 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(2.5 * Game.TS, 4.5 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(2.5 * Game.TS, 2 * Game.TS), purpleActions, true));
...
//                AutoPathHelper.addRollerBackwardMovement(chassis, purpleActions);
                ...
                points.add(new AutoPoint(new Point(2.5 * Game.TS, 4.5 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(2.5 * Game.TS, 2 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(1.5 * Game.TS, 1 * Game.TS), purpleActions, true));
