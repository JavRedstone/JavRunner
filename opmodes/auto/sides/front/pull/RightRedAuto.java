...
public class RightRedAuto extends BaseAuto {
    ...
    public void createPoints() {
        ...
        points.add(new AutoPoint(new Point(6, 2.5 * Game.TS), new ArrayList<>(), true));
...
//                AutoPathHelper.addRollerBackwardMovement(chassis, purpleActions);
                points.add(new AutoPoint(new Point(4.5 * Game.TS, 1.75 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(4.25 * Game.TS, 1 * Game.TS), yellowActions, true));
                break;
            case 2:
//                AutoPathHelper.addRollerBackwardMovement(chassis, purpleActions);
                points.add(new AutoPoint(new Point(4 * Game.TS, 2.5 * Game.TS), purpleActions, true));
