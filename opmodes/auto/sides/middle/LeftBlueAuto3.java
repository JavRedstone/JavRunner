...
public class LeftBlueAuto3 extends BaseAuto {
    ...
    public void createPoints() {
        ...
        points.add(new AutoPoint(new Point(Chassis.HRW, 2.5 * Game.TS), initActions, false));
...
//        AutoPathHelper.addArmDownMovement(chassis, yellowActions);
        ...
        robotSim.startPoint = new Point(Chassis.HRW, 2.5 * Game.TS);
        robotSim.currPoint = robotSim.startPoint;
        robotSim.currHeading = MathHelper.headingToAngle(90);

        switch(route) {
            case 0:
                points.add(new AutoPoint(new Point(1.75 * Game.TS, 2.5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(1.75 * Game.TS, 2 * Game.TS - Chassis.HRW), new ArrayList<>(), true));
                points.add(new AutoPoint(new Point(1.75 * Game.TS, 2.5 * Game.TS), new ArrayList<>(), true));
                points.add(new AutoPoint(new Point(1.5 * Game.TS, 2.5 * Game.TS), new ArrayList<>(), false));
            ...
            case 2:
                points.add(new AutoPoint(new Point(1.75 * Game.TS, 2.5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(1.75 * Game.TS, 3 * Game.TS - Chassis.HRW), new ArrayList<>(), true));
                points.add(new AutoPoint(new Point(1.75 * Game.TS, 0.5 * Game.TS + Chassis.HRW + 0.1), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(1.75 * Game.TS, 0.5 * Game.TS + Chassis.HRW), yellowActions, false));
                break;
            case 1:
            default:
                points.add(new AutoPoint(new Point(2 * Game.TS - Chassis.HRW, 2.5 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(1.5 * Game.TS, 2.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(1.5 * Game.TS, 0.5 * Game.TS + Chassis.HRW + 0.1), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(1.5 * Game.TS, 0.5 * Game.TS + Chassis.HRW), yellowActions, false));
                break;
            }
