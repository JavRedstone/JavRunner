...
public class RightRedAuto3 extends BaseAuto {
    ...
    public void createPoints() {
        ...
        points.add(new AutoPoint(new Point(5.5 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE), new ArrayList<>(), false));
        ArrayList<AutoAction> purpleActions = new ArrayList<>();
        ArrayList<AutoAction> yellowActions = new ArrayList<>();

        robotSim.startPoint = new Point(5.5 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE);
        ...
        switch(route) {
            case 0:
                ...
                points.add(new AutoPoint(new Point(5.25 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE), new ArrayList<>(), false));
            ...
            default:
                ...
                points.add(new AutoPoint(new Point(4.75 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE), new ArrayList<>(), false));
